  ...
  <div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div class="p-4">
            <div class="flex items-start gap-3">
              <img src="/brclogo.png" alt="BRC Market" class="w-10 h-10 rounded-xl object-contain flex-shrink-0" />
    ...
    <Transition name="slide-down">
      <div
        ...
        class="fixed top-4 left-4 right-4 sm:left-auto sm:right-4 sm:w-80 z-50"
      >
