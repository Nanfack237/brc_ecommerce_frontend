            ...
            <div class="flex items-center gap-3 px-6 sm:px-8 py-5 border-b border-gray-50 bg-gradient-to-r from-[#274a82]/5 to-transparent">
              ...
              <div>
                <h2 class="text-base sm:text-lg font-black text-gray-900">
                  {{ currentStep === 1 ? 'Coordonnées & Adresse' : 'Mode de paiement' }}
                </h2>
              ...
              <Transition name="slide" mode="out-in">
                ...
                <div v-if="currentStep === 1" key="s1" class="space-y-4">
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <UFormGroup label="Nom *">
                      <UInput v-model="form.nom" icon="i-heroicons-user" placeholder="Votre nom" size="lg" variant="outline" class="w-full" />
                    </UFormGroup>

                    <UFormGroup label="Prénom">
                      <UInput v-model="form.prenom" icon="i-heroicons-user" placeholder="Votre prénom" size="lg" variant="outline" class="w-full" />
                    </UFormGroup>
                    ...
                    <UFormGroup label="Instructions de livraison" class="sm:col-span-2">
                      <UTextarea v-model="form.infosPlus" placeholder="Points de repère, code d'accès, étage…" size="lg" variant="outline" :rows="3" class="w-full" autoresize />
                    </UFormGroup>
                ...
                <div v-else key="s2" class="space-y-3">
                  ...
                  <div class="flex items-center gap-2 p-3 bg-gray-50 rounded-xl text-xs text-gray-500 mb-4">
                    ...
                    <span>Livraison : <strong class="text-gray-800">{{ [form.quartier, form.ville, form.pays].filter(Boolean).join(', ') }}</strong></span>
                  ...
                  <div v-if="form.payment === 'om'" class="p-4 bg-orange-50 border border-orange-100 rounded-xl">
                    <div class="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-orange-700 leading-relaxed">Après confirmation, le <strong>code marchand Orange Money</strong> vous sera envoyé. Vous aurez <strong>24h</strong> pour effectuer le paiement.</p>
                      </div>
                    </div>
                  </div>
                  <div v-else-if="form.payment === 'momo'" class="p-4 bg-yellow-50 border border-yellow-100 rounded-xl">
                    <div class="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-yellow-700 leading-relaxed">Après confirmation, le <strong>code marchand MTN MoMo</strong> vous sera envoyé. Vous aurez <strong>24h</strong> pour effectuer le paiement.</p>
                      </div>
                    </div>
                  </div>
